  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white shadow-warm hover:shadow-soft transform hover:scale-105",
        calm: "bg-wellness-calm text-card-foreground hover:bg-wellness-calm/80 shadow-gentle",
        energy: "bg-gradient-warm text-white shadow-warm hover:shadow-soft",
        gentle: "bg-gradient-card text-card-foreground hover:bg-muted shadow-gentle border border-border/50",
      },
      size: {
